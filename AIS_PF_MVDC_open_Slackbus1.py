...
def handel(delt):
    ...
    Vslack =  V1ref + delt;  # obtain initial value

    # Bus type [V; P/V; I/V; P; I]
    BUS = [[Vslack, 0, 0, 0, 0, 1], 
           [Vslack, P2ref+ V2ref * K_d[1], 0, 0, 0, 2], 
           [Vslack, 0, I3ref + V3ref * K_d[2], 0, 0, 3],
           [Vslack, 0, 0, P4ref, 0, 4], 
...
def find_Peak():
    ...
    while flag_all != 1 and count < max_iterations:
        ...
        # df.to_excel('BLI_results_slackbus1.xlsx', index=False)
...
# print(f"Results have been saved to 'BLI_results_slackbus1.xlsx'")
